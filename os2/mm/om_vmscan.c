/* $Id: om_vmscan.c,v 1.5 2005/06/28 22:00:53 smilcke Exp $ */

/*
 * om_vmscan.c
 * Autor:               Stefan Milcke
 * Erstellt am:         30.09.2004
 * Letzte Aenderung am: 26.06.2005
 *
*/
...
#ifdef TARGET_OS2
int LX_call_shrinkers(int count)
{
 struct shrinker* shrinker;
 shrink_slab(count,GFP_KERNEL);
 if(down_trylock(&shrinker_sem))
  return 0;
 list_for_each_entry(shrinker,&shrinker_list,list)
 {
  (*shrinker->shrinker)(count,GFP_KERNEL);
 }
 up(&shrinker_sem);
 return 0;
}
