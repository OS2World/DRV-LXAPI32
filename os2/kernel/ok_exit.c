/* $Id: ok_exit.c,v 1.5 2005/03/01 20:53:27 smilcke Exp $ */

/*
 * lk_exit.c
 * Autor:               Stefan Milcke
 * Erstellt am:         28.06.2004
 * Letzte Aenderung am: 15.02.2005
 *
*/
...
asmlinkage long ATTRIB_NORET sys_exit(int error_code)
{
 ...
 */
asmlinkage void ATTRIB_NORET sys_exit_group(int error_code)
{
...
#ifdef TARGET_OS2
//---------------------------- LX_exit_current_exit ----------------------------
void LX_exit_current_exit(struct task_struct* tsk)
{
 long code=0;
 if(tsk->io_context)
  exit_io_context();
