...
/* $Id: ok_timer.c,v 1.7 2005/06/04 23:39:36 smilcke Exp $ */

/*
 * ok_timer.c
 * Autor:               Stefan Milcke
 * Erstellt am:         19.11.2001
 * Letzte Aenderung am: 08.01.2005
 *
*/

#define LX_MODULE_NAME timer
#include <lxcommon.h>
...
fastcall signed long schedule_timeout(signed long timeout)
{
 ...
 {
  struct task_struct* p=current;
  return DevBlock((unsigned long)p,timeout
                  ,(TASK_INTERRUPTIBLE==p->state)? 0 : 1);
 }
 switch (timeout)
 {
