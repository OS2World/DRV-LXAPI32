/* $Id: oak_process.c,v 1.7 2005/12/26 23:42:04 smilcke Exp $ */
...
{
#ifdef TARGET_OS2
 lx_idle_task=current;
#endif
   /* endless idle loop with no priority at all */
   while (1) {
#ifdef TARGET_OS2
      if(atomic_read(&lx_exit_kernel))
       break;
#endif
      while (!need_resched()) {
...
#ifdef TARGET_OS2
int copy_thread(struct task_struct* from,
