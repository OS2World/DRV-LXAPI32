/* $Id: of_buffer.c,v 1.2 2005/05/16 00:11:29 smilcke Exp $ */

/*
 * lf_buffer.c
 * Autor:               Stefan Milcke
 * Erstellt am:         26.06.2004
 * Letzte Aenderung am: 12.05.2005
 *
*/
...
#ifdef TARGET_OS2
   /*
    * Limit the bh occupancy to 5% of ZONE_NORMAL
    */
   nrpages = (nr_free_buffer_pages() * 5) / 100;
#else
   /*
