...
// For now only non static symbols can be exported! (SM)
#define __EXPORT_SYMBOL(sym, sec)   \
   __CRC_SYMBOL(sym, sec)  \
   const char LXRX_EXPORT_SYM_##sym[] \
...
#ifdef TARGET_OS2
#define LX_MODULE_FLAG_INTERNAL        0
#define LX_MODULE_FLAG_EXTERNAL        1
#define LX_MODULE_FLAG_NOT_UNLOADABLE  2
#define LX_MODULE_FLAG_LOADED          4

struct lx_module_option
{
...
#ifdef TARGET_OS2
extern int LX_add_new_module(struct module* mod,int flags);
extern struct module* LX_get_module_struct_from_name(const char* name);
#endif
...
#define LX_MODULE_PARM_EXTRACT(a,b,c,d) a##b##c##d

#define LX_MODULE_PARM(var,type,name) \
struct obsolete_modparm LX_MODULE_PARM_EXTRACT(LXRX_MODPARM_,name,_,var)= \
{ __stringify(LX_MODULE_NAME) ":" __stringify(var),type,&var };

#define MODULE_PARM(var,type)                    \
LX_MODULE_PARM(var,type,LX_MODULE_NAME)
