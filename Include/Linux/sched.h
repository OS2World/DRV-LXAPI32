...
#ifdef TARGET_OS2
extern union thread_union* _init_thread_union;
#define init_thread_union (*_init_thread_union)
#else
...
#ifdef TARGET_OS2
extern void FASTCALL(LX_wake_up_forked_process(struct task_struct* tsk));
extern void FASTCALL(LX_sched_fork(task_t* from,task_t* p));
#endif
...
#ifdef TARGET_OS2
extern int  copy_thread(struct task_struct*, int, unsigned long, unsigned long, unsigned long, struct task_struct *, struct pt_regs *);
#else
