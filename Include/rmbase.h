...
/* Modified for GCC by Stefan Milcke */
...
typedef USHORT (FAR *PFNRMCB)(HRESOURCE hResource); // StM
#endif
...
typedef USHORT (FAR *PFNRMINTHANDLER)(VOID); // (StM)
#endif
...
#define RS_PCI_INT_E    5          /* d255939 */
#define RS_PCI_INT_F    6          /* d255939 */
#define RS_PCI_INT_G    7          /* d255939 */
#define RS_PCI_INT_H    8          /* d255939 */
